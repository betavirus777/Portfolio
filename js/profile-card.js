window.addEventListener("DOMContentLoaded", async function () {
    ...
    document.querySelectorAll(".stack-card").forEach(async function (el) {
        ...
        el.innerHTML = `
        <div style="font-family: -apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji; border-radius: 6px; line-height: 1.5; padding: 16px; font-size: 14px;">
                ...
                <div style="margin-top: 12px; display: flex; justify-content: space-evenly; align-items: center; ">
                    <div style="margin-top: -4px">
                        ...
                        <div style="font-weight: 400; color: #ffffff; font-size: 12px; margin-top: 2px">
                            <span class="stack-card-span" style="font-weight: 600; font-size: 32px; line-height: 1;">
                                618
                            </span>
                        </div>
                    </div>
